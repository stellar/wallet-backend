// Package services provides contract specification validation tests.
// This file tests core functions for contract_spec_validator.go.
package services
...
func TestNewContractSpecValidator(t *testing.T) {
	t.Run("creates validator successfully", func(t *testing.T) {
		...
		validator := NewContractSpecValidator(mockRPC)

		require.NotNil(t, validator)
		assert.IsType(t, &contractSpecValidator{}, validator)
	})
...
func TestValidate(t *testing.T) {
	...
	t.Run("returns empty map for empty input", func(t *testing.T) {
		...
		result, err := validator.Validate(ctx, []xdr.Hash{})
	...
	t.Run("validates single SEP-41 contract", func(t *testing.T) {
		...
		result, err := validator.Validate(ctx, []xdr.Hash{wasmHash})
	...
	t.Run("validates multiple contracts with mixed types", func(t *testing.T) {
		...
		result, err := validator.Validate(ctx, []xdr.Hash{wasmHash1, wasmHash2})
	...
	t.Run("batches requests for more than 10 contracts", func(t *testing.T) {
		...
		result, err := validator.Validate(ctx, wasmHashes)
	...
	t.Run("handles context cancellation", func(t *testing.T) {
		...
		result, err := validator.Validate(cancelledCtx, []xdr.Hash{wasmHash})
...
func TestIsContractCodeSEP41(t *testing.T) {
	mockRPC := NewRPCServiceMock(t)
	validator := &contractSpecValidator{rpcService: mockRPC}
...
func TestExtractContractSpecFromWasmCode(t *testing.T) {
	...
	v := validator.(*contractSpecValidator)
