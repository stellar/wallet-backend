...
type TransactionResolver interface {
	EnvelopeXdr(ctx context.Context, obj *types.Transaction) (*string, error)

	MetaXdr(ctx context.Context, obj *types.Transaction) (*string, error)
...
type Transaction{
  hash:            String!
  envelopeXdr:     String @goField(forceResolver: true)
  resultXdr:       String!
  metaXdr:         String @goField(forceResolver: true)
  ledgerNumber:    UInt32!
  ledgerCreatedAt: Time!
  ingestedAt:      Time!
...
func (ec *executionContext) _Transaction_envelopeXdr(ctx context.Context, field graphql.CollectedField, obj *types.Transaction) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Transaction().EnvelopeXdr(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Transaction_metaXdr(ctx context.Context, field graphql.CollectedField, obj *types.Transaction) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Transaction().MetaXdr(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "envelopeXdr":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Transaction_envelopeXdr(ctx, field, obj)
				return res
			}
		...
		case "metaXdr":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Transaction_metaXdr(ctx, field, obj)
				return res
			}
