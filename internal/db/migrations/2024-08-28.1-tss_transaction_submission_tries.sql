...
CREATE TABLE tss_transaction_submission_tries (
    original_transaction_id VARCHAR(400),
...
CREATE INDEX idx_original_transaction_id ON tss_transaction_submission_tries(original_transaction_id);
...
-- +migrate Down
DROP INDEX IF EXISTS idx_original_transaction_id;
