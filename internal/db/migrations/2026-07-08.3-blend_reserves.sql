...
CREATE TABLE blend_reserves (
    ...
    b_rate               NUMERIC NOT NULL,
    d_rate               NUMERIC NOT NULL,
    b_supply             NUMERIC NOT NULL,
    d_supply             NUMERIC NOT NULL,
    ir_mod               NUMERIC NOT NULL,
    backstop_credit      NUMERIC NOT NULL,
