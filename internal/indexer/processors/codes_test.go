...
func TestStringForManageBuyOfferResult(t *testing.T) {
	tests := []struct {
		...
		{name: "sell_not_authorized", code: xdr.ManageBuyOfferResultCodeManageBuyOfferSellNotAuthorized, expected: "op_sell_not_authorized"},
		{name: "buy_not_authorized", code: xdr.ManageBuyOfferResultCodeManageBuyOfferBuyNotAuthorized, expected: "op_buy_not_authorized"},
		...
		{name: "buy_no_issuer", code: xdr.ManageBuyOfferResultCodeManageBuyOfferBuyNoIssuer, expected: "op_buy_no_issuer"},
...
func TestStringForManageSellOfferResult(t *testing.T) {
	tests := []struct {
		...
		{name: "sell_not_authorized", code: xdr.ManageSellOfferResultCodeManageSellOfferSellNotAuthorized, expected: "op_sell_not_authorized"},
		{name: "buy_not_authorized", code: xdr.ManageSellOfferResultCodeManageSellOfferBuyNotAuthorized, expected: "op_buy_not_authorized"},
		...
		{name: "buy_no_issuer", code: xdr.ManageSellOfferResultCodeManageSellOfferBuyNoIssuer, expected: "op_buy_no_issuer"},
