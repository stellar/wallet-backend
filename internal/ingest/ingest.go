...
func setupDeps(cfg Configs) (services.IngestService, error) {
	...
	ingestService, err := services.NewIngestService(
		models, cfg.LedgerCursorName, cfg.AccountTokensCursorName, cfg.AppTracker, rpcService, ledgerBackend, chAccStore, accountTokenService, contractMetadataService, metricsService, cfg.GetLedgersLimit, cfg.Network, cfg.NetworkPassphrase, archive, cfg.SkipTxMeta, cfg.EnableParticipantFiltering)
	if err != nil {
