...
func setupDeps(cfg Configs) (services.IngestService, error) {
	...
	accountTokenService, err := services.NewAccountTokenService(cfg.NetworkPassphrase, archive, redisStore, models.DB, contractValidator, contractMetadataService, models.TrustlineAsset, accountTokenPool)
	if err != nil {
