...
func (m *StateChangeModel) BatchGetByAccountAddress(ctx context.Context, accountAddress string, columns string, limit *int32, cursor *types.StateChangeCursor, isForward bool) ([]*types.StateChangeWithCursor, error) {
	if columns == "" {
		columns = "*"
	} else {
