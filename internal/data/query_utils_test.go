// Tests for buildDecomposedCursorCondition which decomposes ROW() tuple comparisons
// into OR clauses for TimescaleDB vectorized filtering on compressed hypertables.
package data
